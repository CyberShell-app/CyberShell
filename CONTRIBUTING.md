...
## Report bugs using Github's [issues](https://github.com/CyberShell-app/CyberShell/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/CyberShell-app/CyberShell/issues); it's that easy!
